...
var userAgents = []string{
	...
	"Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.35 (KHTML, like Gecko) Chrome/80.0.3988.132 Safari/537.36",
	"Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.35 (KHTML, like Gecko) Chrome/79.0.3988.131 Safari/537.35",
